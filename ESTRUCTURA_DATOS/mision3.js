/* MISION 3: LISTAS (VECTORES Y MATRICES) EN PYTHON
...
let variable1 = parseInt(prompt(`ingrese un valor para la variable`));
var variable2 = parseInt(prompt(`ingrese un valor para la variable`));
const variable3 = 10;
