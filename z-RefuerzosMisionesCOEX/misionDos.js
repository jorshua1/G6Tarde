...
while (option !== 5) {
  option = parseInt(
    prompt(`Select an option from the menu:
  ...
  while (isNaN(option) || option <= 0 || option > 6) {
    option = parseInt(
      prompt(`¡¡¡PLEASE ENTER THE VALUES CORRECTLY!!!
    ...
    case 1:
      ...
      while (optionSubMenu !== 7) {
        optionSubMenu = parseInt(
          prompt(`Please enter the cell phone brand you want to enter stocks:
        ...
        switch (optionSubMenu) {
          case 1:
            quantity = parseInt(
              prompt(`Please enter the number of Samsung phones you wish to add: 
          ...
          case 2:
            quantity = parseInt(
              prompt(`Please enter the number of Iphone phones you wish to add: 
