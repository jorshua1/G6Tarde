...
let autosVendidos = parseInt(prompt("Por favor ingresar numero de autos vendidos:"));
let valorVehiculos = parseInt(prompt("por favor ingrese el valor de cada vehiculo:"));
