...
var vMenu = parseInt(prompt("Ingrese una opccion del menu \n\n1.Ingrese el numero de talentos "));
while (isNaN(vMenu) || vMenu < 0) {
    vMenu = parseInt(prompt("ERROR DE DATO \nIngrese una opccion del menu \n\n1.Ingrese el numero de talentos \n0.Salir"));
}
switch (vMenu) {
    case 1:
        var vCantidadTalentos = parseInt(prompt("Ingrese el numero de talentos"));
        while (isNaN(vCantidadTalentos) || vCantidadTalentos < 0) {
            vCantidadTalentos = parseInt(prompt("ERROR DE DATO \nIngrese el numero de talentos"));
        }
