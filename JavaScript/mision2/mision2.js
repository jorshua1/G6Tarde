...
if (isNaN(eva1) || eva1>5 || eva1<0){
    ...
    if (isNaN(eva2) || eva2>5 || eva2<0){
        ...
        if(isNaN(tra1) || tra1>5 || tra1<0){
            alert("Error, digite la nota en el rango de 1 a 5")
        }else{
            let tra2=parseFloat(prompt("Ingrese nota trabajo 2"));
            if(isNaN(tra2) || tra2>5 || tra2<0){
                alert("Error, digite la nota en el rango de 1 a 5")
            }else{
                ...
                if (isNaN(examFinal) || examFinal>5 || examFinal<0){
                    alert("Error, digite la nota en el rango de 1 a 5")
                }else{
