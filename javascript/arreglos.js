...
var negro = prompt("ingrese un numero")
console.log(validador(negro));


////////////////////////////////////////////////////////////

function escalera(number) {
  console.log( number > 0 ? "Numero positivo, es creciente" : "Numero negativo, es decreciente");
